...
<head>
    ...
    <title>@yield('title') - EASY GO</title>
    <meta name="description" content="">
    <meta property="og:image" content="{{asset('img/medisync_logo.png')}}">
    <link rel="stylesheet" href="{{asset('css/style.scss')}}">
    <link rel="stylesheet" href="{{asset('css/style.css')}}">
    <link rel="stylesheet" href="{{asset('css/media.css')}}">
    <link rel="icon" type="image/png" href="{{asset('img/medisync_logo.png')}}">
    <!-- BOOSTRAP LINK -->
...
<nav class="navbar navbar-expand-lg ">
  <div class="container">
    <a class="navbar-brand" href="index.php">
        <img src="{{asset('img/medisync_logo.png')}}" alt="">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item mx-2">
          <a class="nav-link" aria-current="page" href="#"><span>Get The App</span></a>
        </li>
        <li class="nav-item me-4">
          <a class="nav-link" aria-current="page" href="#"><span>For Doctors</span></a>
        </li>
        <li class="nav-item mx-2">
          <a class="nav-link" aria-current="page" href="sign_up.php"><span class="blue_f">Login / Sign Up</span></a>
        </li>
        <li class="nav-item mx-2">
          <a class="nav-link" aria-current="page" href="book_appointment.php"><div class="custone_book_appoin_btn d-flex align-items-center">Book Free Appointment</div></a>
        </li>
            ...
            <div class="User_admin">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button class="dropdown-item Manage_Profile_link" type="button">
                                <div class="d-flex align-items-center py-2">
                                    <svg width="16" height="20" class="me-2" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M3.05025 14.0503C4.36301 12.7375 6.14348 12 8 12C9.85652 12 11.637 12.7375 12.9497 14.0503C14.2625 15.363 15 17.1435 15 19H1C1 17.1435 1.7375 15.363 3.05025 14.0503Z" stroke="#0A0101" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>Manage Profile
                                </div>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item appointment_list_link" type="button">
                                <div class="d-flex align-items-center py-2">
    ...
    <div class="container">
        <div class="row mb-4">
                        ...
                        <a href="#">
                            <div class="social_icon d-flex justify-content-center align-items-center">
                                <svg width="20" height="28" viewBox="0 0 20 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 3.33341C6.31812 3.33341 3.33335 6.31818 3.33335 10.0001C3.33335 13.7173 5.48228 19.1565 10 24.0738C14.5178 19.1565 16.6667 13.7173 16.6667 10.0001C16.6667 6.31818 13.6819 3.33341 10 3.33341ZM0.666687 10.0001C0.666687 4.84542 4.84536 0.666748 10 0.666748C15.1547 0.666748 19.3334 4.84542 19.3334 10.0001C19.3334 14.8697 16.4474 21.4383 10.9428 26.9429C10.4221 27.4636 9.57791 27.4636 9.05721 26.9429C3.55261 21.4383 0.666687 14.8697 0.666687 10.0001Z" fill="#A0ABBB"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 11.3334C10.7364 11.3334 11.3334 10.7365 11.3334 10.0001C11.3334 9.2637 10.7364 8.66675 10 8.66675C9.26364 8.66675 8.66669 9.2637 8.66669 10.0001C8.66669 10.7365 9.26364 11.3334 10 11.3334ZM10 14.0001C12.2092 14.0001 14 12.2092 14 10.0001C14 7.79094 12.2092 6.00008 10 6.00008C7.79088 6.00008 6.00002 7.79094 6.00002 10.0001C6.00002 12.2092 7.79088 14.0001 10 14.0001Z" fill="#A0ABBB"/>
                                </svg>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-6 col-md-4 col-lg-2 py-3">
                <div>
                    <h3>Services</h3>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Book Appointment</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Treatment</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Plan Surgery</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">More</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">More</p></a>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2 py-3">
                <div>
                    <h3>About</h3>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">About Us</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Blog</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Careers</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Jobs</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">In Press</p></a>
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-2 py-3">
                <div>
                    <h3>Support</h3>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Contact us</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Online Chat</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Whatsapp</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Telegram</p></a>
                    <a href="#" class="link-underline link-underline-opacity-0"><p class="mb-2">Ticketing</p></a>
                </div>
            </div>
        </div>
        <div class="rightes_line pt-3 text-center">
            <p class="mb-0">© 2000-2021, All Rights Reserved</p>
        </div>
    </div>
 </footer>
 ...
 <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".appointment_list_link").click(function(){
