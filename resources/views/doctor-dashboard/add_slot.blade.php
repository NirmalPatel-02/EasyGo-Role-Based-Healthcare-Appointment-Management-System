...
<main id="main" class="main">
  ...
  <div class="row">
    ...
    <div class="col-lg-6 py-2">
      <div>
        <label for="slotTime" class="mb-2">Select Time <span class="red_f">*</span></label>
        <input type="time" id="slotTime" class="form-control" required>
      </div>
    </div>
    ...
    <div class="col-lg-6 py-2">
      <div>
        <label for="slotDateTime" class="mb-2">Select Date & Time <span class="red_f">*</span></label>
        <input type="datetime-local" id="slotDateTime" class="form-control" required>
      </div>
    </div>
    ...
    <div class="d-flex gap-3 py-4">
      ...
      <a href="#" data-bs-toggle="modal" data-bs-target="#Profile_editModel">
        <div class="Submit_custome_btn">Add</div>
      </a>
    </div>
  </div>
</form>
